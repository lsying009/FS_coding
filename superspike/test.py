...
def test(args, model, device, test_loader, name, sim_params, load_epoch):
    ...
    with torch.no_grad():
        for data, target in test_loader:
            ...
            accuracy_with_time_fr.update_by_sequence(output, output_spikes, loss_fn.target_label)
            accuracy_with_time_fs.update_by_sequence(output, output_spikes, loss_fn.target_label)
